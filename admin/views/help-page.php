...
<div class="wrap fls-admin-page">
	...
	<div class="fls-help-section">
		...
		<p>
			<a href="https://fatlab.com/support" class="button button-primary" target="_blank"><?php esc_html_e( 'Contact Support', 'fatlabschema' ); ?></a>
			<a href="https://fatlab.com/schema-wizard/docs" class="button button-secondary" target="_blank"><?php esc_html_e( 'View Full Documentation', 'fatlabschema' ); ?></a>
		</p>
	</div>
</div>
