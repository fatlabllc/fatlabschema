...
class FLS_Admin {
	...
	public function add_contextual_help() {
		...
		$screen->set_help_sidebar(
			...
			'<p><a href="https://fatlab.com/schema-wizard/docs" target="_blank">' . __( 'Documentation', 'fatlabschema' ) . '</a></p>' .
			'<p><a href="https://fatlab.com/support" target="_blank">' . __( 'Support', 'fatlabschema' ) . '</a></p>'
		);
	}
